...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS =
      ...
      "#companion-pet-root .pet-curtain-cards{position:relative;display:flex;flex-wrap:wrap;justify-content:center;gap:14px;padding:6px 4px;z-index:1}" +
      "#companion-pet-root .pet-curtain-card{width:104px;display:flex;flex-direction:column;align-items:center;gap:8px;padding:14px 8px;border-radius:18px;background:rgba(255,253,246,.85);border:2px solid rgba(120,96,60,.22);color:#6a5538;font-size:14px;font-weight:600;transition:transform .2s,box-shadow .2s,border-color .2s;position:relative;cursor:pointer}" +
